...
All audio files are placeholder tones generated by `scripts/gen-audio-stubs.mjs` (self-generated, CC0).
Replace with real CC0/CC-BY chiptune tracks when available — the manifest (`packages/client/src/audio/asset-manifest.ts`) is the single source of truth for file paths, so swaps require no code changes.

| File | Source | Author | License | Acquired |
|------|--------|--------|---------|---------|
| `public/audio/town-theme.wav` | placeholder — self-generated | Code Quests project | CC0 | 2026-05-28 |
| `public/audio/road-theme.wav` | placeholder — self-generated | Code Quests project | CC0 | 2026-05-28 |
| `public/audio/combat-theme.wav` | placeholder — self-generated | Code Quests project | CC0 | 2026-05-28 |
| `public/audio/boss-theme.wav` | placeholder — self-generated | Code Quests project | CC0 | 2026-05-28 |
| `public/audio/victory-stinger.wav` | placeholder — self-generated | Code Quests project | CC0 | 2026-05-28 |
| `public/audio/quest-complete.wav` | placeholder — self-generated | Code Quests project | CC0 | 2026-05-28 |
| `public/audio/quest-failed.wav` | placeholder — self-generated | Code Quests project | CC0 | 2026-05-28 |
| `public/audio/bell.wav` | placeholder — self-generated | Code Quests project | CC0 | 2026-05-28 |

**Suggested real replacements (CC0, freely usable):**
- Juhani Junkala — Chiptune Adventures (CC0): https://opengameart.org/content/5-chiptunes-action
- HorrorPen — various chiptune SFX (CC0): https://opengameart.org/users/horrorpen
- Eric Matyas / Soundimage.org (CC-BY): https://soundimage.org
...
## Phase 10 — Skills Learning Loop

No new third-party assets in Phase 10. The Coin Monster Type modal, Forge Skill flow, and Library Skills tab are rendered entirely with CSS and existing icon characters from prior packs. No new sprites, audio files, or external asset packs were introduced.

---

## Phase 11 — End-to-End Showcase Demo

No new third-party assets in Phase 11. The showcase capstone wires together existing art, audio, and UI components from Phases 1–10. No new sprites, tilesets, or audio files were introduced. Screenshots in `assets/screenshots/phase-11/` are generated by the Playwright capture spec and are CC0 (project-owned).
