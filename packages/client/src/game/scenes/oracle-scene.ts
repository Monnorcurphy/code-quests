...
export class OracleScene extends BaseBuildingScene {
  ...
  override create(): void {
    ...
    // (Constellation lines removed — they read as random purple noise
    // rather than a starfield. The star sprinkle above is enough.)
    ...
    // No auto-open — user clicks the Crystal Ball (or Seer Caelis) when ready.
